...
const CardTitle = React.forwardRef<TextRef, React.ComponentPropsWithoutRef<typeof Text>>(
  ({ className, ...props }, ref) => (
    <Text
      ...
      ref={ref}
      className={cn(
        "text-2xl text-card-foreground font-PoppinsSemiBold leading-none tracking-tight",
        className
      )}
      {...props}
    />
...
const CardDescription = React.forwardRef<TextRef, React.ComponentPropsWithoutRef<typeof Text>>(
  ({ className, ...props }, ref) => (
    <Text
      ref={ref}
      className={cn("text-sm font-PoppinsMedium text-muted-foreground", className)}
      {...props}
    />
  )
);
...
const CardContent = React.forwardRef<ViewRef, React.ComponentPropsWithoutRef<typeof View>>(
  ({ className, ...props }, ref) => (
    <TextClassContext.Provider value="text-card-foreground PoppinsMedium">
