...
const badgeVariants = cva(
  ...
  web:transition-colors web:focus:outline-none web:focus:ring-2 web:focus:ring-ring
  web:focus:ring-offset-2`,
  {
    variants: {
      variant: {
...
const badgeTextVariants = cva("font-PoppinsSemiBold text-xs ", {
  variants: {
    variant: {
