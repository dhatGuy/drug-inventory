    ...
    <DialogPortal hostName={portalHost}>
      <DialogOverlay closeOnPress={closeOnOverlayClick}>
        <DialogPrimitive.Content
          ref={ref}
          className={cn(
            `z-50 gap-4 border min-w-full web:cursor-default bg-background p-6 shadow-lg
          ...
          <DialogPrimitive.Close
            className="web:group absolute right-4 top-4 rounded-sm p-0.5 opacity-70
              web:ring-offset-background web:transition-opacity web:hover:opacity-100
