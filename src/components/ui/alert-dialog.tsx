      ...
      <AlertDialogOverlay>
        <AlertDialogPrimitive.Content
          ...
          className={cn(
            ...
            shadow-foreground/10 web:duration-200 rounded-lg`,
            open
...
>(({ className, ...props }, ref) => (
  <AlertDialogPrimitive.Title
    ref={ref}
    className={cn("text-lg native:text-xl text-foreground font-PoppinsSemiBold", className)}
    {...props}
  />
));
...
>(({ className, ...props }, ref) => (
  <AlertDialogPrimitive.Description
    ref={ref}
    className={cn("text-sm native:text-base text-muted-foreground font-PoppinsMedium", className)}
    {...props}
  />
));
